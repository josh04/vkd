...
namespace {
    ...
    vkd::ApplicationMode _mode = vkd::ApplicationMode::Standard;
}

namespace vkd {
	class Device;

    ApplicationMode Mode() { return _mode; }

    void render(bool& quit) {

        vkd::renderdoc_start_frame();
        ...
        vkd::renderdoc_end_frame();
    }

    int run(ApplicationMode mode) {
        _mode = mode;
        int width_sm = 1280;
        int height_sm = 720;
